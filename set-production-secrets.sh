...
# Script to set all required secrets for production environment
# Usage: ./set-production-secrets.sh

set -e

ENV="production"
WORKER_NAME="create-story-worker-production"
...
echo "======================================"
echo "✨ Done! All secrets have been set for production environment."
echo ""
