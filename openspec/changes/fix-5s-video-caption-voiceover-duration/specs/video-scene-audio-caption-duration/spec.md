...
- **THEN** the system prompt (and any schema or instructions) MUST state a maximum word count for that scene at **2.8 words/second** so the narration fits within 10 seconds (at most 28 words)
